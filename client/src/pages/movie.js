...
function Movie(props){
    ...
    const increaseLikes = (current_user, id) => {
        ...
        const res = await axios.get(`/api/movies/likeMovie/${current_user}/${id}`);
    ...
    const decreaseLikes = (current_user, id) => {
        ...
        const res = await axios.get(
            `/api/movies/unlikeMovie/${current_user}/${id}`
        );
    ...
    const addToMyFavorite = (current_user, id) => {
        ...
        const results = await axios.post(
            `/api/movies/addMovie/${current_user}/${id}`
        );
        };
    ...
    const removeFromMyFavorite = (current_user, id) => {
        ...
        const res = await axios.post(
            `/api/movies/removeMovie/${current_user}/${id}`
        );
    ...
    <div>
        ...
        <Card.Body>
          ...
          <div style={{ width: 240, height: 240 }}>
            <Card.Img src={props.img} style={{width: 150}} onClick={handleShow} />

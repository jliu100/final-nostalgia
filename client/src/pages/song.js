...
function Song(props) {
  ...
  const increaseLikes = (current_user, id) => {
    ...
    const addLike = async () => {
      ...
      const res = await axios.get(`/api/songs/likeSong/${current_user}/${id}`);
  ...
  const decreaseLikes = (current_user, id) => {
    ...
    const unLike = async () => {
      ...
      const res = await axios.get(
        `/api/songs/unlikeSong/${current_user}/${id}`
      );
  ...
  const addToMyFavorite = (current_user, id) => {
    ...
    const addSong = async () => {
      const results = await axios.post(
        `/api/songs/addSong/${current_user}/${id}`
      );
    };
  ...
  const removeFromMyFavorite = (current_user, id) => {
    ...
    const removeSong = async () => {
      const res = await axios.post(
        `/api/songs/removeSong/${current_user}/${id}`
      );
